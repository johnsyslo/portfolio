  ...
  return (
    <>
      <section className="mt-[35px]">
        ...
        <br></br>
        <Link className="text-sky-500 hover:underline" href="/about">
          about me ➡️
        </Link>
      </section>
      <section className="mt-[35px]">
        ...
        <br></br>
        <Link className="text-sky-500 hover:underline" href="/programming">
          my projects ➡️
        </Link>
      </section>
      <section className="mb-[50px] mt-[35px]">
        ...
        <div className="flex flex-row">
          <Link className="mr-5 text-sky-500 hover:underline" href="https://github.com/johnsyslo">
            github
          </Link>
          <Link className="mr-5 text-sky-500 hover:underline" href="mailto:jsyslo@proton.me">
            email
          </Link>
          <Link
